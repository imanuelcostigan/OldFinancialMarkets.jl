...
@test_throws ArgumentError FinMarkets.easter(2014, Tue)
@test_throws ArgumentError FinMarkets.easter(2014, Wed)
@test_throws ArgumentError FinMarkets.easter(2014, Thu)
@test FinMarkets.easter(Date(2014, 3, 31), Sun) == FinMarkets.easter(2014)
...
@test_throws ArgumentError FinMarkets.seasonstart(999, Dec)
@test_throws ArgumentError FinMarkets.seasonstart(3001, Dec)
@test_throws ArgumentError FinMarkets.seasonstart(1999, Feb)
